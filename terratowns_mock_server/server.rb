...
# This ia a Ruby class that includes validations from ActiveRecord.
...
class Home
  ...
  # create some virtual attribures to store on this object
...
class TerraTownsMockServer < Sinatra::Base
  ...
  #   assign the paylod to variables to make it easier to work with the code 
    name = payload["name"]
    ...
    # printing the variables out to console to make it easier to see or debug what we have inputted into this endpoint
    puts "name #{name}"
    ...
    puts "uuid #{uuid}"
    # will mock our data to our mock databse which is just a global variable
    $home = {
      uuid: uuid,
      name: name,
      town: town,
